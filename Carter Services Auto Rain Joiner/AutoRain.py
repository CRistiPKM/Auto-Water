...
# title and icon
pygame.display.set_caption("Carter Services Rain Auto Joiner")
icon = pygame.image.load("unknown.png")
pygame.display.set_icon(icon)

#Player
playerImg = pygame.image.load("Ez.png")
thing = pygame.transform.scale(playerImg, (300, 220))
credit = pygame.image.load("bozo.png")
credit_ = pygame.transform.scale(credit, (500, 150))
Sprite2 = pygame.image.load("spite.png")
spritesize = pygame.transform.scale(Sprite2, (100, 50))
poper = pygame.image.load("pop.png")
scup = pygame.transform.scale(poper, (300, 220))
...
def player():
    screen.blit(thing, (playerX, playerY))

def scoreboard():
	screen.blit(credit_, (creditX, creditY))

def discord():
	screen.blit(Sprite2, (discordareaW, discordareaH))

def suck():
    screen.blit(scup, (supX, supY))
...
while done == False:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_s and done == False:
               done = True
        suck()
        player()
        scoreboard()
...
class main:
	...
	def getConfig(self): # Get configuration from config.json file
		...
		print("] ", end="")
		print(base64.b64decode(b'Q0FSVEVSIFNFUlZJQ0VT').decode('utf-8'))
		print("[", end="")
		cprint(base64.b64decode(b'IENSRURJVFMg').decode('utf-8'), "cyan", end="")
		print("] ", end="")
		print(base64.b64decode(b'QXV0byBSYWluIEpvaW5lciBCeTogQ2FydGVyIFNlcnZpY2VzICAgaHR0cHM6Ly9kaXNjb3JkLmdnL0poUHVrajlxc1A=').decode('utf-8'))
		time.sleep(3)
		self.clear()
